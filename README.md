...
* **Añadir reto semanal a semana sin retos:** Dado un administrador [admin1] y una semana [01/03/2020] sin retos, cuando este intente añadir un challenge aportando la información necesaria [name="ChallengeTest", description="Test", initialDate="01/03/2020", endDate="05/03/2020", points=10,reps=10,reward="Test",weight=10. , exercise=Exercise1], entonces el reto se creará correctamente.
...
* **Añadir reto semanal a semana con 3 retos:** Dado un administrador[admin1]  y una semana con 2 retos con initialDate=[10/10/2020], cuando este intente añadir dos con el mismo initialDate, entonces se le indicará que no es posible debido a que se ha llegado al máximo de retos esa semana.
