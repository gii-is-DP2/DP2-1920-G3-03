...
class HU09_RoutineManagementByTrainer extends Simulation {
  ...
  setUp(
    updateRoutineSuccessfulScn.inject(rampUsers(7000) during (100 seconds)),
    deleteRoutineOtherTrainerErrorScn.inject(rampUsers(2000) during (100 seconds))).protocols(httpProtocol)
    .assertions(
