...
class HU13_TrainingManagementByTrainer extends Simulation {
  ...
  setUp(
    UpdateTrainingByTrainerSuccessfulScn.inject(rampUsers(6500) during (100 seconds)),
    DeleteTrainingOtherTrainerErrorScn.inject(rampUsers(2500) during (100 seconds))).protocols(httpProtocol)
    .assertions(
