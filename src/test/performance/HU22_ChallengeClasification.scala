...
class HU22_ChallengeClasification extends Simulation {
	...
	setUp(
		challengeClasificationNoCompletedScn.inject(rampUsers(7000) during (100 seconds)), // 9000, 100
		challengeClasificationCompletedScn.inject(rampUsers(3000) during (100 seconds))    // 5000, 100
