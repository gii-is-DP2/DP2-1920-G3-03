...
public class TrainingControllerE2ETest {
	 ...
	 * 
	 * @Test void testListCopyTrainingSuccessful() throws Exception {
	 * mockMvc.perform(get(
	 * "/trainer/{trainerUsername}/clients/{clientId}/trainings/{trainingId}/copyTraining",
	 * "trainer1", String.valueOf(6),
	 * String.valueOf(10))).andExpect(status().isOk())
