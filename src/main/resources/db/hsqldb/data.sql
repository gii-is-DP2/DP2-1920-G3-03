...
INSERT INTO exercises(id,name,description,kcal,intensity,equipment_id,body_part,repetition_type) VALUES (17,'Chest Press','Lie on the ground. Hold bar horizontally to your chest. Kness bent and feet planted on the floor. Extends your arms straight up and then down', 100, 3, 2,0,2);

/* Equipment 3 */
INSERT INTO exercises(id,name,description,kcal,intensity,equipment_id,body_part,repetition_type) VALUES (18,'Plank Disc Switch','Start by doing a plank. Place one disc next to one arm. Then move the disc next to the grabbing arm. Now move the disc to the starting place an repeat',100,3,3,0,0);
INSERT INTO exercises(id,name,description,kcal,intensity,equipment_id,body_part,repetition_type) VALUES (19,'Disc Push Up','Make a Push up having under your hands discs. The more disc the difficultier',100,3,3,0,2);
INSERT INTO exercises(id,name,description,kcal,intensity,equipment_id,body_part,repetition_type) VALUES (20,'Front Shoulder Raise','Hold the disc with both hands with your arms straight forward and the disc at chest height. Like a pendulum raise down the disc until your reach your heap. Then go up and repeat',100,3,3,0,2);
INSERT INTO exercises(id,name,description,kcal,intensity,equipment_id,body_part,repetition_type) VALUES (21,'Lateral Raise','Grab with each hand a disc. Start with them at your hips, then rise up your arms until they are horizontal to the floor. Return to starting position and repeat',100,3,3,0,2);
INSERT INTO exercises(id,name,description,kcal,intensity,equipment_id,body_part,repetition_type) VALUES (22,'Halo','Hold one disc with both hands with your arms slightly bend in fron of you at head height. Move the disc all around your head and return to starting position, then repeat',100,3,3,0,2);
INSERT INTO exercises(id,name,description,kcal,intensity,equipment_id,body_part,repetition_type) VALUES (23,'Squat Press','Start at a crouching position holding a disc with both hands and support your hands with your knees. Stand up and hold the disc above your head. Return to starting position and repeat',100,3,3,4,2);
INSERT INTO exercises(id,name,description,kcal,intensity,equipment_id,body_part,repetition_type) VALUES (24,'Squat Reach','Start at a crouching position holding a disc with both hands having you arms straighten and the disc at chest height. Stand up and bend arms until the disc touches your chest. Return to starting position and repeat',100,3,3,0,2);
INSERT INTO exercises(id,name,description,kcal,intensity,equipment_id,body_part,repetition_type) VALUES (25,'Side Bend','Hold a disc with one hand, the other at your hip. Slightly bend your upper trunk towards the disc side and then straighten up. Repeat and alternate the arm supporting the disc',100,3,3,0,2);
INSERT INTO exercises(id,name,description,kcal,intensity,equipment_id,body_part,repetition_type) VALUES (26,'Overhead Press','Hold a disc with both hands and horizontal to the floor. Disc should be at neck height, then move it above your head with extended arms. Return to starting position and repeat',100,3,3,1,2);

/* Equipment 4 */
INSERT INTO exercises(id,name,description,kcal,intensity,equipment_id,body_part,repetition_type) VALUES (27,'Goblet Squat','Standing up, with your feet separated widely (distance should be wider than shoulders distance). Grab a dumbbell with both hands and make a squat. Return to starting position and repeat',100,3,4,3,2);
...
INSERT INTO exercises(id,name,description,kcal,intensity,equipment_id,body_part,repetition_type) VALUES (38,'Kettlebell Thrusters','Each hand with a kettle. Squat and when your all standing, extend your arm fully up above your head. Return to starting position and repeat',100,1,5,1,2);
INSERT INTO exercises(id,name,description,kcal,intensity,equipment_id,body_part,repetition_type) VALUES (39,'Kettlebell Clean and Press','Stand holding two kettlebells by your thighs, knees slightly bent and legs shoulder-width apart. In one swift movement, slightly jump off the ground and raise your arms to extend above your head',100,1,5,4,2);
INSERT INTO exercises(id,name,description,kcal,intensity,equipment_id,body_part,repetition_type) VALUES (40,'Kettlebell Snatch','Holding a kettlebell in one hand between your legs, squat down. Drive upwards through your hips and knees as the kettlebell rises to shoulder height. Return to starting position and repeat',100,0,5,4,2);
INSERT INTO exercises(id,name,description,kcal,intensity,equipment_id,body_part,repetition_type) VALUES (41,'Kettlebell Pistol Squad','Hold one kettlebell with both hands just under your chin. Lift one leg off the floor and squat down with the other. Return to starting position and repeat',100,0,5,3,2);
INSERT INTO exercises(id,name,description,kcal,intensity,equipment_id,body_part,repetition_type) VALUES (42,'Kettlebell Gobel Squat','Stand with your legs slightly wider than shoulder-width apart, clasping a kettlebell in each hand in front of your chest with palms facing each other. Bend your knees and lower yourself into a squat. Return to starting position and repeat.',100,0,5,3,2);
INSERT INTO exercises(id,name,description,kcal,intensity,equipment_id,body_part,repetition_type) VALUES (43,'Kettlebell Shoulder Press','Stand with your feet shoulder-width apart holding two kettlebells at shoulder height. Press one of the weights above your head until your arm is fully extended. Lower and repeat with the other arm.',100,0,5,1,2);

/* Equipment 6 */
INSERT INTO exercises(id,name,description,kcal,intensity,equipment_id,body_part,repetition_type) VALUES (44,'Sprint','Run at full speed',100,0,6,4,0);
INSERT INTO exercises(id,name,description,kcal,intensity,equipment_id,body_part,repetition_type) VALUES (45,'Jogging','Run at a speed that you could maintain "forever"',100,0,6,4,0);
INSERT INTO exercises(id,name,description,kcal,intensity,equipment_id,body_part,repetition_type) VALUES (46,'Walking','Walk at a suitable speed',100,0,6,4,0);
INSERT INTO exercises(id,name,description,kcal,intensity,equipment_id,body_part,repetition_type) VALUES (47,'Course-Navette','Alternate between high intensity running (85%) and medium-low intensity (60%). 1:30 min at 85% and 3:30 at 60% ',100,0,6,4,0);

/* Equipment 7 */
INSERT INTO exercises(id,name,description,kcal,intensity,equipment_id,body_part,repetition_type) VALUES (48,'Elliptical Max Speed','Use the Ellipitical at the higuest pace you can keep',100,0,7,4,0);
INSERT INTO exercises(id,name,description,kcal,intensity,equipment_id,body_part,repetition_type) VALUES (49,'Elliptical Med Speed','Use the Ellipitical at a pace you can keep "forever"',100,0,7,4,0);
...
/* No equipment*/
INSERT INTO exercises(id,name,description,kcal,intensity,equipment_id,body_part,repetition_type) VALUES (60,'Abs','Lie on the floor looking upwards. Bend knees and rotate your upper trunk to your knees. Return to starting position and repeat',100,1,null,0,2);
INSERT INTO exercises(id,name,description,kcal,intensity,equipment_id,body_part,repetition_type) VALUES (61,'Plank','Lie on the floor looking downwards. Support yourself only with your bend forearms and feet. Keep a straight position',100,1,null,0,0);
INSERT INTO exercises(id,name,description,kcal,intensity,equipment_id,body_part,repetition_type) VALUES (62,'Push ups','Lying with the face down by raising and lowering the body with the straightening and bending of the arms',100,0,null,0,2);
...
INSERT INTO exercises(id,name,description,kcal,intensity,equipment_id,body_part,repetition_type) VALUES (64,'Burpees','First make a squat then place the palms of the hands on the floor in front of the feet and finally jumps back into a push-up position',100,0,null,4,2);
INSERT INTO exercises(id,name,description,kcal,intensity,equipment_id,body_part,repetition_type) VALUES (65,'Jumping Jacks','First start by jumping to a position with legs spread and arms raised and then return to the original position',100,0,null,4,2);
