...
// 	public String processUpdateDietForm(@Valid Client client, BindingResult result,
...
public String processDietCreateForm(@Valid Diet diet, BindingResult result,
		...
		if (result.hasErrors()) {
			return "trainer/diets/dietCreateOrUpdate";		
		}
		else {
			this.dietService.saveDiet(diet);
