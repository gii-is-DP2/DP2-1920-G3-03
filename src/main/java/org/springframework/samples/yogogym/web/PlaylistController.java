...
public class PlaylistController {
	...
	public String getPlaylistOfTraining(RestTemplate restTemplate, Model model, @PathVariable("trainingId") int trainingId) throws ResourceNotFoundException {
